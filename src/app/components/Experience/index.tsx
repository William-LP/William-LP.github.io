        ...
        <section id="experience" className='py-12 bg-gray-50 dark:bg-gray-800'>
            <div className='container mx-auto px-6 max-w-4xl'>
                ...
                <div className='space-y-8'>
                    {appData.experience.slice(0, showMore ? appData.experience.length : 3).map((experience, i) => (
                        <div key={i} className='flex gap-6'>
                            ...
                            <div className='flex-1'>
                                ...
                                {experience.description && (
                                    <div className='text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-3'>
                                        <ul className='list-disc'>
                                            {experience.description.map((elem) => (
                                                <li key={elem}>{elem}</li>
                                            ))}
                                        </ul>
                                    </div>
